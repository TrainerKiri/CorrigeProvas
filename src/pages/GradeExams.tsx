...
import GradeExamForm from '../components/exams/GradeExamForm';
  ...
  return (
    <SidebarLayout>
      ...
      <h1 className="text-2xl font-semibold text-gray-900 mb-6">
        Grade Exams - {exam.title}
      </h1>
      
      {students.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-8 text-center">
          <h2 className="text-xl font-medium text-gray-900 mb-4">No Students Available</h2>
          <p className="text-gray-600 mb-6">
            You need to add students before you can grade exams.
          </p>
